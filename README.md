...
This is a project template for a greenfield Java project. It's named after the main character in the cartoon Bob the Builder. Given below are instructions on how to use it.
